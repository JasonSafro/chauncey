<?php
add_action('widgets_init','gym_video_load_widgets');


function gym_video_load_widgets(){
		register_widget("Gym_Video_Widget");
}

class Gym_Video_Widget extends WP_widget{
	
	function Gym_Video_Widget(){
		$widget_ops = array('classname' => 'gym_video_widget', 'description' => 'Video Widget');

		$control_ops = array('id_base' => 'gym_video_widget');

		$this->WP_Widget('gym_video_widget', 'Gym : Video Widget', $widget_ops, $control_ops);
