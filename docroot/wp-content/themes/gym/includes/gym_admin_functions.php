...
{   
    wp_register_style( 'gym_admin_style', SYSTEM_ROOT."/includes/gym_admin_style.css");
    wp_enqueue_style( 'gym_admin_style' );    
...
function my_admin_jquery() {
    wp_register_script( 'gym_admin', SYSTEM_ROOT."/includes/gym_admin.js");
    wp_enqueue_script('gym_admin');
    wp_register_script("gym_dashboard_twitter", SYSTEM_ROOT."/includes/twitter.js"); 
    wp_enqueue_script('gym_dashboard_twitter');  
}
...
function posts_columns($defaults){
    $defaults['gym_post_thumbs'] = __('Thumb');
    return $defaults;
}
function posts_custom_columns($column_name, $id){
    if($column_name === 'gym_post_thumbs'){
        echo the_post_thumbnail( array(100, 60) );
    }
}
...
function gym_what_to_show($field, $default, $echo = true)
{
...
function gym_form_text($id, $title = null, $width = 500, $default = null, $desc = null, $class = null)
{
    $html = "<tr valign='top' class='$class'>\n";
    $html .= "<th scope='row'><label for='$id'>$title</label></th>\n";
    $html .= "<td>\n";
    $html .= "  <input type='text' name='$id' id='$id' value=\"". gym_what_to_show($id, $default, false)."\" style='width:" . $width . "px'/>\n";
...
function gym_form_textarea($id, $title = null, $width = 500, $rows = 4, $default = null, $desc = null, $class = null)
{
    $html = "<tr valign='top' class='$class'>\n";
    $html .= "<th scope='row'><label for='$id'>$title</label></th>\n";
    $html .= "<td>\n";
    $html .= "<textarea rows='$rows' name='$id' id='$id' style='width:" . $width . "px'>". gym_what_to_show($id, $default, false) ."</textarea>\n";
    //$html .= gym_what_to_show($id, $default, false)."\n";
    //$html .= "</textarea>\n"; 
    $html .= "<span class='description'>$desc</span>\n";
    $html .= "</td>\n";
    $html .= "</tr>\n";
...
function gym_form_select($id, $title = null, $options = null, $default = "Please select", $desc = null, $class = null)
{
    $default_selected = "";
...
function gym_form_upload($id = "", $title = null, $default = null, $desc = "Upload file, or choose it from the media library", $submit = "Upload", $class = null)
{
    $html = "<tr valign='top'  id='tr_$id' class='$class'>\n";
    $html .= "<th scope='row'><label for='$id'>$title</label></th>\n";
    $html .= "<td>\n";
    $html .= "<input id='$id' type='text' style='width:400px' name='$id' value='".gym_what_to_show($id, $default, false)."' />\n";
    ...
    $html .= "</script>\n"; 
    $html .= "<span class='description'>$desc</span>\n";
    $html .= "<div id='". $id ."_show'><img src='".gym_what_to_show($id, $default, false)."'></div>\n"; 
    $html .= "</td>\n";
    $html .= "</tr>\n";
...
function my_custom_dashboard_widgets() 
{
    ...
    wp_add_dashboard_widget('custom_help_widget', 'GymWP updates', 'custom_dashboard_system');
}
...
<div id="gym_dashboard_twitter"></div>    
    <?php
}
